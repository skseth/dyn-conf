...
describe("Config", function() {
    ...
    const modifiedConfigDefault = JSON.parse(JSON.stringify(nometaConfigDefault))
    ...
    describe('#getPropValue()', function() {
        ...
        it('should replace secret with actual value', function() {
            ...
            const secretConfigDefault = JSON.parse(JSON.stringify(nometaConfigDefault))
            ...
            const secretconfig = new Config(secretConfigDefault)
                    .setSecretSource({ getSecret(name) { return (name === 'pwd')? expectedPass: 'UNKNOWN' }})
